  ...
  return (
    <div className="row" id="search-delete-add-row">
      ...
      <div className="col-md-3 col-6">
        ...
        <Button className="btn btn-success float-right btn-sm mr-2 mb-1" id="add-expense-button" data-toggle="modal" data-target="#add-expense-modal" type="button" onClick={toggle}>Add</Button>
      </div>
    </div>
  );
}
